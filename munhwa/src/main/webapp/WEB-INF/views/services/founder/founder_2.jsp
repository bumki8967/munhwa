...
<body class="Pretendard">
    ...
    <div class="sub_visu" style="background: url(../assets/images/founder_bg.png) no-repeat center center;">
        <div class="wrap">
            <h2>설립자 소개</h2>
        ...
        <div class="wrap">
            <div class="snb">
                ...
                <ul>
                    ...
                    <li class="on">
                        <a href="./founder_2.html">
                            <h5>프로필</h5>
                            <i><img src="../assets/images/dot.png" alt=""></i>
                        </a>
                    </li>
                    <li>
                        <a href="./founder_3.html">
                            <h5>삶의 철학</h5>
                            <i><img src="../assets/images/dot.png" alt=""></i>
                        </a>
                    </li>
                    <li>
                        <a href="./founder_4.html">
                            <h5>저서</h5>
                            <i><img src="../assets/images/dot.png" alt=""></i>
                        </a>
                    </li>
            ...
            <div class="cont">
                ...
                <div class="top_img">
                    <img src="../assets/images/founder_2_img1.png" alt="">
                </div>
                <div class="history">
                    <div class="tit">
                        경력
