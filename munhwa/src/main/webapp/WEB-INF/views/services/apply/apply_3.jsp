    ...
    <div class="content">
        <div class="wrap">
            ...
            <div class="cont">
                ...
                <div class="desc_box">
                    <p class="mt-0">
                        (재)가천문화재단은 인륜의 기본이 되며 우리 전통문화의 핵심이 되는 아름다운 효정신을 전국민들에게 선양하기 위해 전국에 걸쳐 효녀 및 효부를 선발하여, 효행상을 수여합니다. 또한 다문화가정을 돕고 있는 개인 및 단체를 발굴, 시상하여 우리 사회에 귀감이 되도록 하는데 앞장서고 있습니다. 지극한 효심으로 성심껏 효를 행하는 효녀와 다문화가정의 효부, 그리고 다문화가정을 물심양면으로 지원하는 여러 단체/개인들이 선발되도록 지대한 관심과 많은 추천을 부탁드리며, 다음과 같이 공모 합니다.
                    </p>                 
                    <br>
                    <p class="dot_list">
                        <span class="point dotted">*</span> 부모님의 장애 여부나 지역 등과 무관하게 시상합니다.
                    </p>                    
                </div>
                        ...
                        <li>
                            ...
                            <div class="num_list green">
                                ...
                                <ul>
                                    <li>
                                        <div class="num">1</div>
                                        <p>대한민국 국적을 가진 만11～24세의 각급 학교(유사학교 포함) 재학중인 여학생</p>
                                    </li>
                                    <li>
                                        <div class="num">2</div>
                                        <p>부모님과 웃어른을 공경하며 평소 효와 예를 실천해온 여학생 </p>
                                    </li>
                                    <li>
                                        <div class="num">3</div>
                                        <p>일상에서 가정의 행복을 위해 노력하는 여학생 </p>
                                    </li>
                                    <li>
                                        <div class="num">4</div>
                                        <p>품행이 단정하고 솔선수범하여 다른 학생들의 모범이 되는 여학생 </p>
                                    </li> 
                                </ul>
                            </div>
                            ...
                            <div class="num_list green">
                                ...
                                <ul>
                                    <li>
                                        <div class="num">1</div>
                                        <p>다문화가정의 안정과 행복을 위해 물심양면 힘써온 단체(개인)  </p>
                                    </li>
                                    <li>
                                        <div class="num">2</div>
                                        <p>이주민의 정착을 돕고 구성원으로서 참여할 수 있도록 지원해온 단체(개인) </p>
                                    </li>
                                    <li>
                                        <div class="num">3</div>
                                        <p>다문화에 대한 이해증진과 건강한 다문화사회 형성을 위해 노력하는 단체(개인) </p>
                                    </li>
                                </ul>
                            </div>                            
                        </li>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p>2021년 11월 ~ 12월 예정(장소 및 시간 등 추후통보)</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
