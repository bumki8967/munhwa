...
<body class="Pretendard">
    ...
    <div class="sub_visu" style="background: url(../assets/images/apply_bg1.png) no-repeat center center;">
        <div class="wrap">
            <h2>신청/참여</h2>
    ...
    <div class="content">
        <div class="wrap">
            ...
            <div class="cont">
                ...
                <div class="desc_box">
                    <p class="mt-0">
                        (재)가천문화재단이 인천과 경기지역 문화예술 단체 및 작가들의 활발하고 창의적인 문화예술활동을 지원하기 위해 ‘경인지역 문화예술 창작활동 지원사업’을 진행합니다.
                        <br/><br/>
                        지난 2003년 국내 메세나 단체 최초로 대한민국 문화예술상을 수상했던 가천문화재단은 2006년부터 본 사업을 정례화하여 많은 문화예술단체(개인)들을 후원해왔습니다.
                    </p>                 
                </div>
                    ...
                    <ul class="list type2">  
                        ...
                        <li>
                            ...
                            <p class="dot_list">
                                ...
                                <span class="dotted">·</span>  플래카드 및 인쇄물 등 사업에 따른 모든 인쇄물에 ‘이 (공연, 전시, 연주, 출판 등)은 (재)가천문화재단 2022년 문화예술 창작활동 지원금을 받은 사업입니다.’<br/>
                                라는 문구 명기
                            </p>
                            <div class="notice_info">
                                ...
                                <ul>
                                    <li>가천문화재단 홈페이지</li>
                                    <li><img src="../assets/images/info_next.png" alt=""></li>
                                    <li>자료실</li>
                                    <li><img src="../assets/images/info_next.png" alt=""></li>
                                    <li>행사자료 이용</li>
                                </ul>
