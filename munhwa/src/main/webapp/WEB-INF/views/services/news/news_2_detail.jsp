                    ...
                    <div class="detail_box">
                        ...
                        <div class="content">
                            <div class="con_img" style="text-align: center;">
                                <img src="${pageContext.request.contextPath }/assets/images/docu_img2.png" alt="">
                            </div>
                        </div>
                        <div class="previous">
                            <ul>
                                <li>
                                    ...
                                    <div class="right">
                                        <a href="${pageContext.request.contextPath }/services/news/news_2_detail.jsp">
