            ...
            <div class="cont">
                ...
                <div class="gallery_info">
                    <ul>
                        <li>
                            <div class="img_wrap">
                                <div class="img type1" style="background: url(../assets/images/concert1.png) no-repeat center center;"></div>
                            </div>
                            <div class="txt">
                                <h4>
                                    <span>2011</span><br/>
                        ...
                        <li>
                            ...
                            <div class="img_wrap">
                                <div class="img type1" style="background: url(../assets/images/concert2.png) no-repeat center center;"></div>
                            </div>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            <div class="img_wrap">
                                <div class="img type1" style="background: url(../assets/images/concert3.png) no-repeat center center;"></div>
                            </div>
                            <div class="txt">
                                <h4>
                                    <span>2013</span><br/>
                        ...
                        <li>
                            ...
                            <div class="img_wrap">
                                <div class="img type1" style="background: url(../assets/images/concert4.png) no-repeat center center;"></div>
                            </div>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            <div class="img_wrap">
                                <div class="img type2" style="background: url(../assets/images/concert5.png) no-repeat center center;"></div>
                            </div>
                            <div class="txt">
                                <h4>
                                    <span>2016</span><br/>
                        ...
                        <li>
                            ...
                            <div class="img_wrap">
                                <div class="img type2" style="background: url(../assets/images/concert6.png) no-repeat center center;"></div>
                            </div>
                    ...
                    <ul>
                        <li>
                            <div class="img_wrap">
                                <div class="img type2" style="background: url(../assets/images/concert7.png) no-repeat center center;"></div>
                            </div>
                            <div class="txt">
                                <h4>
                                    <span>2018</span><br/>
